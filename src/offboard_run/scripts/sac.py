...
class SACContinuous:
    ...
    def take_action(self, state):
        ...
        action = self.actor(state)[0].detach().cpu().numpy().reshape(-1)
        return action
    ...
    def update(self, transition_dict):
        ...
        return actor_loss.item(), critic_1_loss.item()
    ...
    def save(self, path, i):
            torch.save({
                ...
                'critic_1_optimizer_state': self.critic_1_optimizer.state_dict(),
                'critic_2_optimizer_state': self.critic_2_optimizer.state_dict()
    ...
    def load(self, path, i):
        ...
        self.critic_1_optimizer.load_state_dict(checkpoint['critic_1_optimizer_state'])
        self.critic_2_optimizer.load_state_dict(checkpoint['critic_2_optimizer_state'])
