...
if __name__ == "__main__":
    ...
    for i_episode in range(episode_from, 50000):
        ...
        if i_episode % 100 == 0 or early_stop or need_store:
            ...
            parameter_keys = ['episode', 'total_iterated', 'actor_lr', 'critic_lr', 'alpha_lr', 
                            'batch_size', 'tau', 'gamma', 'buffer_size', 'minimal_size', 'sigma', 'hidden_dim']
            parameter_values = [i_episode, total_iterated, actor_lr, critic_lr, alpha_lr, 
                                batch_size, tau, gamma, buffer_size, minimal_size, sigma, hidden_dim]
